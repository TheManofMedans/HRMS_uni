...
namespace HRMS.Infrastructure.Migrations
{
    ...
    [Migration("20260914101812_newdatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMS.domain.Entities.Company", b =>
                {
                    ...
                    b.Property<int>("LateDeductionType")
                        .HasColumnType("int");

                    b.Property<decimal>("LateDeductionValue")
            ...
            modelBuilder.Entity("HRMS.domain.Entities.MailMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMS.domain.Entities.MailThread", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMS.domain.Entities.MailThreadParticipant", b =>
                {
                    b.Property<int>("ThreadId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("MailThreadParticipants", (string)null);
                });
            ...
            modelBuilder.Entity("HRMS.domain.Entities.PaySlip", b =>
                {
                    ...
                    b.HasIndex("EmployeeId", "DepartmentId", "WeekStart", "WeekEnd")
                        .IsUnique();
            ...
            modelBuilder.Entity("HRMS.domain.Entities.MailMessage", b =>
                {
                    b.HasOne("HRMS.domain.Entities.User", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HRMS.domain.Entities.MailThread", "Thread")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("HRMS.domain.Entities.MailThread", b =>
                {
                    ...
                    b.HasOne("HRMS.domain.Entities.Request", "RelatedRequest")
                        .WithMany()
            ...
            modelBuilder.Entity("HRMS.domain.Entities.Notification", b =>
                {
                    b.HasOne("HRMS.domain.Entities.Attendance", "Attendance")
                        .WithMany()
                        .HasForeignKey("AttendanceId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("HRMS.domain.Entities.Request", "Request")
                        .WithMany()
